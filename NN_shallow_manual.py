# -*- coding: utf-8 -*-
"""
Created on Wed Sep  5 14:47:57 2018
...
import sys 
import os
sys.path.append(os.path.abspath("c:\\vincent\\script\\python"))
...
class Planar_NN:
    ...
    def train(self,X, Y, n_h, num_iterations = 10000, print_cost=True):
        """
        Arguments:
